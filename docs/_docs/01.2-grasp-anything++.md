...
- [1] An Dinh Vuong, Minh Vu, Baoru Huang, Nghia Nguyen, Hieu Le, Thieu Vo, Anh Nguyen. Language-driven Scene Synthesis using Multi-conditional Diffusion Model. In CVPR, 2024.
