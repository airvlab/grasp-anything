...
- [1] [An Dinh Vuong](https://andvg3.github.io/), Minh Vu, Baoru Huang, Nghia Nguyen, Hieu Le, Thieu Vo, [Anh Nguyen](https://www.csc.liv.ac.uk/~anguyen/). *Language-driven Scene Synthesis using Multi-conditional Diffusion Model*. In CVPR, 2024.
